...
%subplot(1,3,2);imshow(resizeImage_bilinearRes_011,[]);title('resized_bilinear x1/12.5 image');
...
%subplot(1,3,3);imshow(resizeImage_bilinearRes_110,[]);title('resized_bilinear 1/12.5x12.5ximage');
